...
function App() {
  ...
  function handleDeleteMovie(movieId) {
    apiMain.deleteMovie(movieId, localStorage.token)
    .then(() => {
  ...
  function toggleMovie(data) {
    ...
    if (isSaved) {
      ...
      apiMain.saveMovie(data, localStorage.token)
        .then(res => {
    ...
    <CurrentUserContext.Provider value={currentUser}>
      <div className="page">
        <Routes>
          ...
          <Route path="/movies" element={<Movies savedMovies={savedMovies} saveMovie={toggleMovie}  isLogged={isLogged}/>} />
          <Route
            path="/profile"
            element={
          ...
          />
          <Route path="/saved-movies" element={<SavedMovies savedMovies={savedMovies} deleteMovie={handleDeleteMovie} isLogged={isLogged}/>} />
